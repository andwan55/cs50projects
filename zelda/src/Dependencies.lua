...
require 'src/states/entity/player/PlayerHoldState'
...
gTextures = {
    ...
    ['character-hold'] = love.graphics.newImage('graphics/character_pot_walk.png'),
...
gFrames = {
    ...
    ['character-hold'] = GenerateQuads(gTextures['character-hold'], 16, 32),
