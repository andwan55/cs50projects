...
function Dungeon:init(player)
    ...
    -- track the total number of rooms we've cleared
    self.clearCount = 0

    -- all possible drops from loot chest per room clear
    self.lootTable = {'potion', 'sword-fire', 'sword-poison', 'crossbow-ice', 'crossbow-acid'}
